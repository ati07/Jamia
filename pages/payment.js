...
export default function SimpleTabs() {
  ...
  const img = ["/Receipt/R1.png", "/Receipt/R2.png", "/Receipt/R3.png"];
  ...
  return (
    <div>
      <div className={classes.root}>
        ...
        <div className="flex justify-between mt-10 items-center w-[90%]">
  ...
  />
        ...
        <div className="w-[90%] mt-5">
          <div>
            ...
            {/* Add More paymnet or filter popup */}
            <Dialog
              open={open}
              onClose={handleClose}
            ...
            >
              <DialogTitle id="form-dialog-title">
                {filter?"Filter":'Add Receipt Details'}
              </DialogTitle>
              <DialogContent>
                {filter?
                ...
                :<>
                <div className="grid grid-cols-12 gap-1 w-[500px]">
